...
export default function ShopTableStaff() {
    ...
    return (
        <Box m="20px">
            ...
            <div style={{color:"#3045FF", fontSize:34, fontWeight:900, marginLeft:550,fontFamily:'serif'}}>POST</div>
            <div style={{color:"#2a2d64", fontSize:20, fontWeight:900,padding:20}}>Quản Lý Sản Phẩm</div>
            <FilterComponent
                label="Loại Sản phẩm"
                name="shopType"
                shopType={shopType}
